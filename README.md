...
<li> converter: is a handler permitting to convert a file type in a attachment. Actually is set up less,sass,styl,yalm,coffee,typescript converters. You can add other converters directly in options.</li>
 <li> preprocessor: bindep can use a additional preprocessor for attachments passing directly options in your tag-block.The preprocessor syntax you can embed in you attachments can be find [here](https://github.com/nashdot/Preprocessor.js) </li>
